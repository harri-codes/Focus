<form action="/save-event" method="post" id="form_main">
    ...
    <div class="row mt-4">
        <div class="col-6">
            ...
            <input class="form-control" name="start_date" type="datetime" id="start_date"   @if(!empty($event))value="{{$event->start_date}}" @else value="{{date('Y-m-d')}}"
                @endif>
        </div>
        <div class="col-6">
    ...
    <div class="form-group">
        ...
        <textarea class="form-control" rows="10" id="description" name="description">@if (!empty($event)){!! $event->description !!}@endif</textarea>
    </div>
