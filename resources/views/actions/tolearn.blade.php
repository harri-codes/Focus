                        ...
                        @foreach($to_learns as $to_learn)
                            <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    ...
                                    <span class="text-xs mb-4">{{__('Start Learning')}} <span class="text-dark ms-sm-2 font-weight-bold">{{$to_learn->start_date}}</span></span>

                                    <span class="text-xs">{{__('Date to Finish:')}} <span class="text-dark ms-sm-2 font-weight-bold">{{$to_learn->end_date}}</span></span>
                                </div>
