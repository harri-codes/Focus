            ...
            <div class="col-xl-5 ms-auto mt-xl-0 mt-4">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6 mt-md-0 mt-4">
                        <div class="card">
                            <div class="card-body text-center">
                                <h1 class="text-gradient text-dark"><span id="status4" countto="417">{{$total_projects}}</span></h1>
                                <h6 class="mb-0 font-weight-bolder">{{__('Projects')}}</h6>
                            ...
                            <td>
                                <div class="d-flex px-2 py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="mb-0 text-xs">{{$project->title}}</h6>
                                ...
                                <div class="d-flex mt-4">
                                    ...
                                    <div class="ms-3">
                                        <div class="numbers">
                                            ...
                                            <span class="text-sm">{{$event->start_date}}---<span class="text-sm">{{$event->end_date}}</span></span>
